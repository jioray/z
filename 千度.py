...
# 发布地址：https://www.qddizhi.cyou/
    ...
    def homeContent(self, filter):
        ...
        result = {}
        result['class'] = []
        result['class'].append({'type_id': '/best/2025-03', 'type_name': '热门2025年3月'})
        result['class'].append({'type_id': '/best/2025-02', 'type_name': '热门2025年2月'})
        result['class'].append({'type_id': '/best/2025-01', 'type_name': '热门2025年1月'})
        result['class'].append({'type_id': '/best/2024-12', 'type_name': '热门2024年12月'})
        result['class'].append({'type_id': '/best/2024-11', 'type_name': '热门2024年11月'})
        result['class'].append({'type_id': '/best/2024-10', 'type_name': '热门2024年10月'})
        result['class'].append({'type_id': '/best/2024-09', 'type_name': '热门2024年9月'})
        result['class'].append({'type_id': '/best/2024-08', 'type_name': '热门2024年8月'})
        result['class'].append({'type_id': '/best/2024-07', 'type_name': '热门2024年7月'})
        result['class'].append({'type_id': '/best/2024-06', 'type_name': '热门2024年6月'})
        result['class'].append({'type_id': '/best/2024-05', 'type_name': '热门2024年5月'})
        result['class'].append({'type_id': '/best/2024-04', 'type_name': '热门2024年4月'})
